...
Este repositório foi criado como ponto de partida para explorar as capacidades do Claude Code no fluxo de trabalho de desenvolvimento de software, incluindo:
...
- Uso de skills e hooks personalizados
